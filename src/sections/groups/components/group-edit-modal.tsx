...
import { groupService, type UpdateGroupRequest, type UserGroup } from '@/services/groupService';
...
export function GroupEditModal({ open, onClose, group }: GroupEditModalProps) {
  ...
  const handleInputChange = (field: keyof UpdateGroupRequest, value: string) => {
    setFormData(prev => ({
      ...prev,
      [field]: value,
    }));
